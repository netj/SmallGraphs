...
define('smallgraph/syntax',["require", "exports", "module"], function(require, exports, module) {
...
define('smallgraph/serialize',["require", "exports", "module"], function(require, exports, module) {
// Generated by CoffeeScript 1.3.1
(function() {
  var serialize, serializeConstraint, serializeExpr, serializeStep;

  exports.serializeExpr = serializeExpr = function(expr) {
    switch (typeof expr) {
      case 'string':
  ...
  exports.serializeConstraint = serializeConstraint = function(conj) {
    var c, disj;
    if (conj) {
      return ((function() {
        ...
        for (_i = 0, _len = conj.length; _i < _len; _i++) {
          ...
          _results.push("[" + (((function() {
            ...
            _results1 = [];
            for (_j = 0, _len1 = disj.length; _j < _len1; _j++) {
              c = disj[_j];
              _results1.push("" + c.rel + (serializeExpr(c.expr)));
            }
            return _results1;
          })()).join("; ")) + "]");
        }
  ...
  exports.serialize = serialize = function(smallgraph) {
    var aggfn, attr, attrNameOrNameWithConstraint, constraint, d, decl, ord, s, step, _i, _j, _len, _len1, _ref, _ref1;
    s = "";
    for (_i = 0, _len = smallgraph.length; _i < _len; _i++) {
      ...
      if (decl.walk) {
        ...
        if (d[1] && d[1].length > 0) {
          ...
          s += ((function() {
            ...
            for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
              _ref2 = _ref1[_k], attr = _ref2[0], aggfn = _ref2[1], constraint = _ref2[2];
        ...
        d = decl.orderby;
        if (!(((_ref1 = decl.orderby) != null ? _ref1.length : void 0) > 0)) {
          continue;
        }
        s += "order by ";
        s += ((function() {
...
define('smallgraph/main',["require", "exports", "module", "./syntax","./serialize"], function(require, exports, module) {
// Generated by CoffeeScript 1.3.1
(function() {
  var f, i, parseConstraint, parseExpr, _ref;

  exports.parse = (require("./syntax")).parse;

  exports.parseExpr = parseExpr = JSON.parse;

  exports.parseConstraint = parseConstraint = function(s) {
    var c, cStr, disjStr, disjStrs, m, _i, _len, _results;
    disjStrs = s.replace(/^\[(.*)\]$/, "$1").split(/\s*\]\[\s*/);
    _results = [];
    for (_i = 0, _len = disjStrs.length; _i < _len; _i++) {
      disjStr = disjStrs[_i];
      if (disjStr === "") {
        _results.push([]);
      } else {
  ...
  exports.normalize = function(q) {
    var eliminateEmptyConstraints;
    eliminateEmptyConstraints = function(q) {
      var decl, elim, _i, _j, _len, _len1;
      elim = function(s) {
        if ((s.constraint != null) && s.constraint.length === 0) {
          return delete s.constraint;
        }
      };
...
// AMD wrapper for D3
// See-Also: https://groups.google.com/d/msg/d3-js/PSPKF8V0D00/8MSRvjilCrsJ
define('d3.AMD',['order!d3'], function() { return d3; });
...
(function() {
  ...
  require(["order!jquery", "smallgraph/main", "d3.AMD", "order!jquery-ui", "order!jquery.svg", "order!jquery.svgdom", "order!jquery.cookie", "order!less"], function($, smallgraph, d3) {
    var DOM_VK_A, DOM_VK_BACK_SPACE, DOM_VK_DELETE, DOM_VK_M, EdgeAttributeMark, EdgeLabelLeft, EdgeLabelTop, EdgeMarkerSize, EdgeReverseMark, EntryHeight, EntryWidth, Identity, LabelForType, ModifierKeys, MouseMoveThreshold, NodeConstraintTextHeight, NodeConstraintXSpacing, NodeConstraintYSpacing, NodeHeight, NodeLabelLeft, NodeLabelTop, NodeRounding, NodeTypes, NodeWidth, QuantitativeTypes, ResultFillColors, ResultPaddingH, ResultPaddingV, ResultPageSize, ResultScale, ResultUpdateTransitionDuration, SVGNameSpace, SketchpadAction, SketchpadActionHandler, addToSketchpad, adjustEdgeLayout, aggregationSelectionPrototype, aggregationSetupInProgress, attributeNodeLabelForType, attributeNodesOf, borderWithPadding, constraintInputPrototype, createNode, determineNodeConstraintType, edgeId, emptyObjectSchema, emptySchema, generalizeConstraint, getAttributeDataTypeOf, getEdge, getLabelAttributeNameOfNode, getNode, intersection, keySet, nodeId, nullNode, orderingSelectionPrototype, pathbox, prefixAttributeMark, prefixReverseMark, queryTypeEntryHandler, queryTypeEntryShow, queryTypeEntryWasBlurred, removeAll, results, sketch, sketchpad, sketchpadActionDefSatisfyModifierKey, sketchpadAction_AddConstraint, sketchpadAction_AddNode, sketchpadAction_DrawEdgeFromANode, sketchpadAction_MoveNode, sketchpadAction_RemoveSelection, sketchpadAction_SelectArea, sketchpadAction_SelectNodeOrEdge, sketchpadAction_SetupAggregation, sketchpadAction_SwitchMode, sketchpadAction_ToggleAggregation, sketchpadClearSketch, sketchpadCurrentKeyActions, sketchpadCurrentMode, sketchpadCurrentMouseActions, sketchpadCurrentOrdering, sketchpadCurrentSelection, sketchpadDblClick, sketchpadDoc, sketchpadFirstMouseEvent, sketchpadKeyActions, sketchpadKeyDown, sketchpadKeyUp, sketchpadMode, sketchpadModeButton, sketchpadMouseActions, sketchpadMouseDown, sketchpadMouseMove, sketchpadMouseUp, sketchpadPageLeft, sketchpadPageTop, sketchpadPervasiveMode, sketchpadPhantomNode, sketchpadSelectionBox, sketchpadSetupAggregation, sketchpadSetupAggregationForSelection, sketchpadSetupConstraint, sketchpadSetupConstraintForSelection, sketchpadSetupOrdering, sketchpadSetupOrderingForSelection, sketchpadSwitchToMode, sketchpadToggleAggregation, smallgraphsCompileSketchToQuery, smallgraphsCurrentOffset, smallgraphsCurrentQuery, smallgraphsCurrentResultMapping, smallgraphsCurrentResultOverview, smallgraphsCurrentResultPrototype, smallgraphsGraphSchema, smallgraphsGraphURL, smallgraphsGraphURLHistory, smallgraphsGraphURLOriginalMessage, smallgraphsLoadSchema, smallgraphsOriginalTitle, smallgraphsResetSchema, smallgraphsRunQuery, smallgraphsSendQuery, smallgraphsShowDialog, smallgraphsShowError, smallgraphsShowGraphURLPicker, smallgraphsShowResults, smallgraphsToggleResultSelection, translate, updateEdgeCoordinates, updateNodeConstraintDisplay;
    ...
    NodeLabelLeft = 0;
    NodeLabelTop = 5;
    NodeConstraintTextHeight = 8;
    NodeConstraintXSpacing = 5;
    NodeConstraintYSpacing = 5;
    NodeRounding = 10;
    EdgeMarkerSize = 12;
    EdgeLabelLeft = 0;
    EdgeLabelTop = 5;
    ...
    ResultPaddingH = 0.2;
    ResultPaddingV = 0.2;
    ResultUpdateTransitionDuration = 1000;
    ResultFillColors = ["#eb912b", "#7099a5", "#c71f34", "#1d437d", "#e8762b", "#5b6591", "#59879b"];
    QuantitativeTypes = {
    ...
    */
    ...
    smallgraphsShowDialog = function(selector, options, msg) {
      var dialog;
    ...
    smallgraphsShowError = function(msg) {
      return smallgraphsShowDialog("#error-dialog", {
        title: "Error",
        buttons: [
          {
            text: "OK",
    ...
    */
    ...
    smallgraphsShowGraphURLPicker = function() {
      var finishGraphURLInput, urlDialog;
      finishGraphURLInput = function() {
        var newURL;
        newURL = $("#graph-url-input").val();
        if (newURL !== smallgraphsGraphURL) {
          smallgraphsGraphURL = newURL;
          return smallgraphsLoadSchema();
        }
      };
      urlDialog = smallgraphsShowDialog("#graph-url-dialog", {
        ...
        buttons: {
          "Continue Disconnected": function() {
            $(this).dialog("close");
            return smallgraphsResetSchema();
          },
          "Connect": function() {
            $(this).dialog("close");
            return finishGraphURLInput();
          }
        },
        close: function() {
          return $("#graph-url-input").blur();
        }
      });
      return $("#graph-url-input").val(smallgraphsGraphURL != null ? smallgraphsGraphURL : "http://localhost:53411/").keyup(function() {
    ...
    getLabelAttributeNameOfNode = function(node) {
      var _ref;
      return (_ref = smallgraphsGraphSchema.Objects[node.objectType]) != null ? _ref.Label : void 0;
    };
    getAttributeDataTypeOf = function(node, attrName) {
      var _ref;
      return (_ref = smallgraphsGraphSchema.Objects[node != null ? node.objectType : void 0]) != null ? _ref.Attributes[attrName] : void 0;
    };
    smallgraphsOriginalTitle = document.title;
    smallgraphsGraphURLOriginalMessage = $("#graph-url").html();
    smallgraphsResetSchema = function() {
      sketchpadClearSketch();
      $("#graph-url").html(smallgraphsGraphURLOriginalMessage);
      smallgraphsGraphSchema = emptySchema;
      return NodeTypes = [];
    };
    smallgraphsLoadSchema = function() {
      smallgraphsGraphURL = smallgraphsGraphURL.replace(/\/$/g, "");
      console.log("loading graph", smallgraphsGraphURL);
      document.title = "" + smallgraphsOriginalTitle + " of " + smallgraphsGraphURL;
      $("#graph-url").text(smallgraphsGraphURL);
      return $.getJSON(smallgraphsGraphURL + "/schema", function(schema) {
        var links, lnType, objType, targetObjType, targetObjTypes, _ref, _results;
        ...
        _results = [];
        for (objType in _ref) {
          links = _ref[objType].Links;
          _results.push((function() {
            var _results1;
            _results1 = [];
            for (lnType in links) {
              targetObjTypes = links[lnType];
              _results1.push((function() {
                var _base, _i, _len, _ref1, _ref2, _ref3, _results2;
                _results2 = [];
                for (_i = 0, _len = targetObjTypes.length; _i < _len; _i++) {
                  targetObjType = targetObjTypes[_i];
                  _results2.push(((_ref1 = (_base = ((_ref2 = schema.Objects[targetObjType]) != null ? (_ref3 = _ref2.RevLinks) != null ? _ref3 : _ref2.RevLinks = {} : void 0))[lnType]) != null ? _ref1 : _base[lnType] = []).push(objType));
                }
                return _results2;
              })());
            }
    ...
    */
    ...
    nodeId = 0;
    createNode = function(x, y, w, h, nr) {
      var node;
      if (w == null) {
        w = NodeWidth;
      }
    ...
    removeAll = function(allElements, elementsToRemove) {
      if ((elementsToRemove != null ? elementsToRemove.length : void 0) > 0) {
        return allElements.filter(function(n) {
          return elementsToRemove.indexOf(n) === -1;
        });
      } else {
        return allElements;
      }
    ...
    attributeNodeLabelForType = function(xsdType) {
      var label;
    ...
    */
    ...
    pathbox = function(x1, y1, x2, y2) {
      return "M" + x1 + " " + y1 + "\nL" + x2 + " " + y1 + "\nL" + x2 + " " + y2 + "\nL" + x1 + " " + y2 + "\nZ";
    };
    updateEdgeCoordinates = function(e, x2, y2) {
      var curvature, dratio, dx2, dxm, dy2, dym, r, x1, xm, y1, ym;
      r = Math.sqrt(x2 * x2 + y2 * y2);
      x1 = r < e.source.w ? 0 : e.source.w * x2 / r;
      y1 = r < e.source.h ? 0 : e.source.h * y2 / r;
      dx2 = (EdgeMarkerSize + e.target.w) * x2 / r;
      dy2 = (EdgeMarkerSize + e.target.h) * y2 / r;
      dratio = 0.2;
      curvature = 0.05 * e.degree;
      dxm = curvature * y2;
      dym = -curvature * x2;
      xm = x2 / 2;
      ym = y2 / 2;
      $("path", e).attr({
        d: "M" + x1 + " " + y1 + " Q " + (xm + 2 * dxm) + " " + (ym + 2 * dym) + ", " + (x2 - dx2 + dratio * dy2) + ", " + (y2 - dy2 - dratio * dx2)
      });
      return $("text", e).attr({
        x: xm + dxm,
        y: ym + dym
    ...
    adjustEdgeLayout = function() {
      var e, es, _i, _len;
      es = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    ...
    */
    ...
    $(sketchpad).bind("selectstart", function() {
      return event.preventDefault();
    });
    sketch = $("#query-sketch")[0];
    addToSketchpad = function(name, attrs, target) {
      var node;
    ...
    sketchpadClearSketch = function() {
      var edgeId;
      nodeId = edgeId = 0;
      return $("*", sketch).remove();
    };
    attributeNodesOf = function(n) {
      return $(".attribute.node", sketch).filter(function() {
        return this.subjectId === n.id;
      });
    };
    queryTypeEntryHandler = null;
    queryTypeEntryWasBlurred = null;
    borderWithPadding = 3;
    $("#query-type-input").css({
      ...
      if (queryTypeEntryWasBlurred) {
        return queryTypeEntryWasBlurred = clearTimeout(queryTypeEntryWasBlurred);
      }
    }).blur(function() {
      if (queryTypeEntryHandler != null) {
        return queryTypeEntryWasBlurred = setTimeout(function() {
          if (queryTypeEntryHandler != null) {
            queryTypeEntryHandler();
            queryTypeEntryHandler = null;
          }
          return $("#query-type-entry").removeClass("active");
        }, 200);
      }
    });
    queryTypeEntryShow = function(x, y, list, done) {
      var input;
      if (queryTypeEntryWasBlurred) {
    ...
    */
    ...
    sketchpadAction_AddNode = {
      ...
      click: function() {
        ...
        if (event.target === sketchpad) {
          ...
          queryTypeEntryShow(sketchpad.offsetLeft + event.offsetX - EntryWidth, sketchpad.offsetTop + event.offsetY - EntryHeight, NodeTypes, function(type) {
            if (type) {
              ...
              return console.log("added node", type, node);
            } else {
              return $(node).remove();
            }
          });
    ...
    sketchpadAction_MoveNode = {
      ...
      mousedown: function() {
        ...
        if (n) {
          ...
          $(".edge", sketchpad).each(function(i, e) {
            if (e.source === n) {
              return starting.push(e);
            } else if (e.target === n) {
              return ending.push(e);
            }
          });
      ...
      mousemove: function() {
        ...
        this.edgesStarting.forEach(function(e) {
          ...
          x2 = e.target.x - x;
          y2 = e.target.y - y;
          return updateEdgeCoordinates(e, x2, y2);
        });
        return this.edgesEnding.forEach(function(e) {
          var x2, y2;
          x2 = x - e.source.x;
          y2 = y - e.source.y;
          return updateEdgeCoordinates(e, x2, y2);
    ...
    EdgeAttributeMark = "@";
    EdgeReverseMark = "^";
    prefixAttributeMark = function(t) {
      return EdgeAttributeMark + t;
    };
    prefixReverseMark = function(t) {
      return EdgeReverseMark + t;
    };
    nullNode = {
      w: 0,
      h: 0
    ...
    sketchpadAction_DrawEdgeFromANode = {
      ...
      mousedown: function() {
        ...
        if (n != null) {
          ...
          $(e).addClass("drawing");
          this.objectSchema = (_ref = ((_ref1 = smallgraphsGraphSchema.Objects) != null ? _ref1 : {})[n.objectType]) != null ? _ref : emptyObjectSchema;
          this.allowedEdgeTypes = (keySet(this.objectSchema.Links)).concat(keySet(this.objectSchema.RevLinks).map(prefixReverseMark)).concat((attrs = keySet(this.objectSchema.Attributes), this.objectSchema.Label != null ? attrs = removeAll(attrs, [this.objectSchema.Label]) : void 0, attrs).map(prefixAttributeMark));
          return this;
        }
      },
      mousemove: function() {
        var allowedEdgeTypesToTarget, dx, dy, e, n, r, targetObjectSchema, tx, ty, x2, y2, _ref;
        tx = event.offsetX;
        ty = event.offsetY;
        n = getNode(event.target);
        if (n != null) {
          if (n === this.edge.source) {
            n = null;
          } else if (n.isAttributeNode) {
            n = null;
          }
        }
        e = this.edge;
        ...
        if (n != null) {
          e.target = n;
          e.degree = 1 + $(".edge", sketch).filter(function() {
            return this !== e && this.source === e.source && this.target === e.target;
          }).length;
          ...
          x2 = n.x - this.sx;
          y2 = n.y - this.sy;
          targetObjectSchema = (_ref = smallgraphsGraphSchema.Objects[n.objectType]) != null ? _ref : emptyObjectSchema;
          allowedEdgeTypesToTarget = (intersection(keySet(this.objectSchema.Links), keySet(targetObjectSchema.RevLinks))).concat(intersection(keySet(this.objectSchema.RevLinks), keySet(targetObjectSchema.Links)).map(prefixReverseMark));
      ...
      mouseup: function() {
        var allowedEdgeTypesToTarget, e, lx, ly, n, objSchema, tx, ty;
        e = this.edge;
        n = getNode(event.target);
        ...
        if (n === this.edge.source) {
          ...
          return $(e).remove();
        } else if ((n != null) && !n.isAttributeNode) {
          e.target = n;
          e.degree = 1 + $(".edge", sketch).filter(function() {
            return this !== e && this.source === e.source && this.target === e.target;
          }).length;
          allowedEdgeTypesToTarget = this.allowedEdgeTypesToTarget;
          return queryTypeEntryShow(lx, ly, allowedEdgeTypesToTarget, function(type) {
            var node;
            if (type) {
              if (smallgraphsGraphSchema !== emptySchema) {
              ...
              if (type.substring(0, EdgeReverseMark.length) === EdgeReverseMark) {
                type = type.substring(EdgeReverseMark.length);
                node = e.target;
                e.target = e.source;
                e.source = node;
                adjustEdgeLayout(e);
              ...
              return console.log("added edge", type, e);
            } else {
              return $(e).remove();
            }
          });
          ...
          return queryTypeEntryShow(lx, ly, this.allowedEdgeTypes, function(type) {
            var allowedNodeTypes, attrNode, node;
            $(sketchpadPhantomNode).removeClass("active");
            $("rect", sketchpadPhantomNode).attr({
              width: 0,
              height: 0
            ...
            if (type) {
              if (type.substring(0, EdgeAttributeMark.length) === EdgeAttributeMark) {
                type = type.substring(EdgeAttributeMark.length);
                attrNode = createNode(tx, ty, NodeWidth / 2, NodeHeight / 2, 0);
                ...
                return console.log("added attribute edge", type, e);
              } else {
                ...
                $("text", e).text(type);
                $(e).removeClass("drawing");
                if ((allowedNodeTypes != null ? allowedNodeTypes.length : void 0) > 0) {
                  $(e).removeClass("invalid");
                } else {
                  if (smallgraphsGraphSchema !== emptySchema) {
                    $(e).addClass("invalid");
                ...
                return setTimeout(function() {
                  return queryTypeEntryShow(sketchpad.offsetLeft + tx - EntryWidth, sketchpad.offsetTop + ty - EntryHeight, allowedNodeTypes.sort(), function(nodeType) {
                    if (nodeType) {
                      ...
                      return console.log("added edge", type, e, "with a node", nodeType, node);
                    } else {
                      $(node).remove();
                      return $(e).remove();
                    }
    ...
    sketchpadAction_SelectNodeOrEdge = {
      ...
      click: function() {
        var isDoingMultipleSelection, nodeOrEdge, _ref;
        nodeOrEdge = (_ref = getNode(event.target)) != null ? _ref : getEdge(event.target);
        if (nodeOrEdge != null) {
          if (isDoingMultipleSelection = event.metaKey || event.ctrlKey) {
    ...
    sketchpadAction_SelectArea = {
      name: "select area",
      mousedown: function() {
        var isDoingMultipleSelection, x1, y1;
        if (event.target === sketchpad) {
          x1 = this.x1 = event.offsetX;
          y1 = this.y1 = event.offsetY;
          this.rect = $("rect", sketchpadSelectionBox).attr({
            x: x1,
            y: y1,
            width: 0,
            height: 0
      ...
      mousemove: function() {
        var nodesInBox, nodesOutOfBoxNow, x1, x2, xl, xu, y1, y2, yl, yu;
        x1 = this.x1;
        y1 = this.y1;
        ...
        yl = Math.min(y1, y2);
        yu = Math.max(y1, y2);
        nodesInBox = $(".node", sketchpad).filter(function(i) {
          var x, y;
          x = this.x;
          y = this.y;
          return xl <= x && x <= xu && yl <= y && y <= yu;
        }).addClass("selected").toArray();
        ...
        return sketchpadCurrentSelection = this.initialSelection.concat(nodesInBox);
      },
      mouseup: function() {
    ...
    sketchpadCurrentOrdering = null;
    sketchpadAction_RemoveSelection = {
      name: "remove selection",
      keypress: function() {
        var alsoRemoveTargetAttributeNodes;
        alsoRemoveTargetAttributeNodes = function() {
          var _ref;
          if (((_ref = this.target) != null ? _ref.isAttributeNode : void 0) != null) {
            return $(this.target).remove();
          }
        };
        $("#ordering-list li").each(function() {
          var _ref;
          if (_ref = this.node, __indexOf.call(sketchpadCurrentSelection, _ref) >= 0) {
            return $(this).remove();
          }
        });
        sketchpadCurrentOrdering = removeAll(sketchpadCurrentOrdering, sketchpadCurrentSelection);
        $(".edge", sketchpad).filter(function() {
          var _ref, _ref1;
          return (_ref = this.source, __indexOf.call(sketchpadCurrentSelection, _ref) >= 0) || (_ref1 = this.target, __indexOf.call(sketchpadCurrentSelection, _ref1) >= 0);
        }).each(alsoRemoveTargetAttributeNodes).remove();
        $(sketchpadCurrentSelection).each(alsoRemoveTargetAttributeNodes).remove();
        return sketchpadCurrentSelection = [];
      }
    };
    updateNodeConstraintDisplay = function(node, constraintType) {
      var constraintText;
      if (constraintType == null) {
        constraintType = determineNodeConstraintType(node)[0];
      }
      constraintText = $("text.constraint", node);
      if (node[constraintType] != null) {
        if (constraintText.length === 0) {
          ...
          }, node)).addClass("constraint");
        }
        return constraintText.text((smallgraph.serializeConstraint(node[constraintType])).replace(/^\[(.*)\]$/, "$1"));
      } else {
        return constraintText.remove();
      }
    };
    determineNodeConstraintType = function(node) {
      var attrDataType, attrName, constraintType, labelAttr, subjectNode;
      ...
      return [constraintType, subjectNode, attrName, attrDataType];
    };
    constraintInputPrototype = null;
    sketchpadSetupConstraint = function(nodes) {
      return null;
    };
    sketchpadSetupConstraintForSelection = function() {
      return null;
    };
    sketchpadAction_AddConstraint = {
      name: "add constraints",
      dblclick: function() {
        var attrName, constraint, constraintString, constraintType, done, node, normalizeConstraint, subjectNode, _ref;
        node = getNode(event.target);
        if (node != null) {
          _ref = determineNodeConstraintType(node), constraintType = _ref[0], subjectNode = _ref[1], attrName = _ref[2];
          done = false;
          constraintString = $("text.constraint", node).text();
          while (!done) {
            try {
              constraintString = prompt("Enter the constraint for " + attrName + " of " + subjectNode.objectType + "(" + subjectNode.id + ")\n e.g. >123  or  =\"small graphs\".", constraintString);
              if (constraintString == null) {
                return;
              }
              if (constraintString) {
                normalizeConstraint = function(cStr) {
                  var expr, m, rel, _;
                  cStr = cStr.replace(/^\s+|\s+$/g, "");
                  if (m = cStr.match(/^(=|!=|<=|<|>|>=)\s*(.*)$/)) {
                    _ = m[0], rel = m[1], expr = m[2];
                  } else {
                    rel = "=";
                    expr = cStr;
                  }
          ...
          return updateNodeConstraintDisplay(node, constraintType);
        }
      }
    };
    $("#query-constraint").button().click(sketchpadSetupConstraintForSelection);
    aggregationSelectionPrototype = {};
    $("#aggregation-list li").each(function() {
      return aggregationSelectionPrototype[$(this).attr("for")] = this;
    }).remove();
    sketchpadSetupAggregation = function(attrNodes) {
      var agglst, aggregationSetupInProgress, finishAggregationForm, idx;
      ...
      attrNodes.forEach(function(attrNode) {
        var dataType, listitem, newId;
        dataType = QuantitativeTypes[attrNode.attributeType] != null ? "Quantitative" : "Ordinal";
        ...
        $("label", listitem).attr({
          "for": newId
        }).text("" + ($("#" + attrNode.subjectId + " text", sketch).text()) + " " + (prefixAttributeMark(attrNode.attributeName)));
        $("select", listitem).attr("id", newId).val(attrNode.aggregateFunction);
        attrNode.aggregateFunction = $("select", listitem).val();
        return agglst.append(listitem);
      });
      finishAggregationForm = function() {
        return $("li", agglst).each(function() {
          return this.attributeNode.aggregateFunction = $("select", this).val();
        });
      };
      return smallgraphsShowDialog("#aggregation-dialog", {
        ...
        buttons: [
          {
            ...
            click: function() {
              ...
              $(this).dialog("close");
              return aggregationSetupInProgress = false;
            }
          }
        ],
        close: function() {
    ...
    sketchpadSetupAggregationForSelection = function() {
      var aggAttrNodes;
      aggAttrNodes = [];
      sketchpadCurrentSelection.forEach(function(n) {
        if ($(n).hasClass("aggregate") && $(n).hasClass("node")) {
          if ($(n).hasClass("attribute")) {
            return aggAttrNodes.push(n);
          } else {
            return aggAttrNodes = aggAttrNodes.concat(attributeNodesOf(n).toArray());
          }
        }
      });
      return sketchpadSetupAggregation(aggAttrNodes);
    };
    aggregationSetupInProgress = false;
    sketchpadToggleAggregation = function() {
      ...
      sketchpadCurrentSelection.forEach(function(n) {
        if ($(n).hasClass("node") && !$(n).hasClass("attribute")) {
          ...
          return attributeNodesOf(n).toggleClass("aggregate");
        }
      });
      return sketchpadSetupAggregationForSelection();
    };
    $("#query-aggregate").button().click(sketchpadToggleAggregation);
      ...
      dblclick: function() {
        ...
        if (node != null) {
          if ($(node).hasClass("aggregate")) {
            if ($(node).hasClass("attribute")) {
              return sketchpadSetupAggregation([node]);
            } else {
              return sketchpadSetupAggregation(attributeNodesOf(node).toArray());
            }
          }
        }
      }
    ...
    sketchpadSetupOrdering = function(orderbyNodes) {
      var clearOrdering, finishOrderingForm, idx, orderlst;
      ...
      orderbyNodes.forEach(function(node) {
        ...
        $("label", listitem).attr({
          "for": newId
        }).text($(node).hasClass("attribute") ? "" + ($("#" + node.subjectId + " text", sketch).text()) + " " + (prefixAttributeMark(node.attributeName)) : $("text", node).text());
        $("select", listitem).attr("id", newId).val(node.ordering);
        node.ordering = $("select", listitem).val();
        return orderlst.append(listitem);
      });
      orderlst.sortable();
      orderlst.disableSelection();
      clearOrdering = function() {
        $(".orderby-desc.node, .orderby-asc.node", sketch).removeClass("orderby-desc").removeClass("orderby-asc");
        return sketchpadCurrentOrdering = [];
      };
      finishOrderingForm = function() {
        clearOrdering();
        return $("li", orderlst).each(function() {
          this.node.ordering = $("select", this).val();
          $(this.node).addClass("orderby-" + this.node.ordering);
          return sketchpadCurrentOrdering.push(this.node);
        });
      };
      return smallgraphsShowDialog("#ordering-dialog", {
    ...
    sketchpadSetupOrderingForSelection = function() {
      var orderbyNodes;
      orderbyNodes = sketchpadCurrentOrdering.concat(removeAll(sketchpadCurrentSelection.filter(function(n) {
        return $(n).hasClass("node");
      }), sketchpadCurrentOrdering));
      return sketchpadSetupOrdering(orderbyNodes);
    };
    $("#query-order").button().click(sketchpadSetupOrderingForSelection);
    sketchpadAction_SwitchMode = {
      ...
      keypress: function() {
        ...
        return modes.each(function(i, b) {
          if (b === currentMode) {
            return $(modes[(i + 1) % modes.length]).click();
          }
        });
      }
    };
    ...
    */
    ...
    sketchpadMode = {};
    sketchpadModeButton = $("#query-mode").buttonset();
    sketchpadMouseActions = [];
    sketchpadKeyActions = [];
    SketchpadActionHandler = function(handlerPrototype) {
      var i;
      for (i in handlerPrototype) {
    ...
    sketchpadPervasiveMode = [
      {
        ...
        handler: sketchpadAction_RemoveSelection,
        forKeys: [DOM_VK_BACK_SPACE = 8, DOM_VK_DELETE = 46]
      }, {
        handler: sketchpadAction_SwitchMode,
        forKeys: [DOM_VK_M = 77]
      }, {
        handler: sketchpadAction_ToggleAggregation,
        forKeys: [DOM_VK_A = 65]
      }, {
    ...
    sketchpadSwitchToMode = function(modeName) {
      var keyActionHandlers, mode, mouseActionHandlers;
      ...
      mode.forEach(function(mapping) {
        ...
        if (h.mousedown || h.click || h.dblclick) {
          return mouseActionHandlers.push(h);
        } else if (h.keydown || h.keypress) {
          h.forKeys = mapping.forKeys;
          return keyActionHandlers.push(h);
        }
      });
      sketchpadCurrentMode = mode;
      sketchpadMouseActions = mouseActionHandlers;
      return sketchpadKeyActions = keyActionHandlers;
    };
    sketchpadSwitchToMode($("#query-mode input[checked]").val());
    sketchpadModeButton.change(function() {
      return sketchpadSwitchToMode(event.target.value);
    });
    /*
    ...
    */
    ...
    SketchpadAction = function(handler) {
      var i;
      for (i in handler) {
        this[i] = handler[i];
      }
    ...
    sketchpadActionDefSatisfyModifierKey = function(handler) {
      var keyIsOn;
      if (handler.modifierKeys != null) {
        keyIsOn = function(modifier) {
          return event[modifier + "Key"];
        };
        if (!(handler.modifierKeys.every(keyIsOn) && !removeAll(ModifierKeys, handler.modifierKeys).some(keyIsOn))) {
          return false;
        }
      } else {
    ...
    sketchpadMouseDown = function() {
      sketchpadFirstMouseEvent = event;
      return sketchpadMouseActions.forEach(function(handler) {
        var a, r;
        if (handler.mousedown != null) {
          if (!sketchpadActionDefSatisfyModifierKey(handler)) {
            return;
          }
          try {
            ...
            if (r != null) {
              ...
              if (r) {
                return sketchpadCurrentMouseActions.push(a);
              }
            }
          } catch (err) {
    ...
    sketchpadMouseMove = function() {
      return sketchpadCurrentMouseActions.forEach(function(a) {
        try {
          if (a.mousemove != null) {
            console.debug(event.type, event, a, a.name);
            return a.mousemove();
    ...
    sketchpadMouseUp = function() {
      ...
      sketchpadCurrentMouseActions = [];
      if (Math.abs(event.pageX - sketchpadFirstMouseEvent.pageX) < MouseMoveThreshold && Math.abs(event.pageY - sketchpadFirstMouseEvent.pageY) < MouseMoveThreshold) {
      ...
      return sketchpadFirstMouseEvent = null;
    };
    sketchpadDblClick = function() {
      return sketchpadMouseActions.forEach(function(handler) {
        var a;
        if (handler.dblclick != null) {
          if (!sketchpadActionDefSatisfyModifierKey(handler)) {
            return;
          }
          try {
          ...
          if (handler.keydown != null) {
            try {
              ...
              if (r != null) {
                console.debug(event.type, event, a, a.name);
                if (r) {
                  return sketchpadCurrentKeyActions.push(a);
                }
              }
            } catch (err) {
              return console.error(err, err + "");
    ...
    sketchpadKeyUp = function() {
      ...
      return sketchpadKeyActions.forEach(function(handler) {
        var a;
        if ((handler.keypress != null) && (handler.forKeys != null) && handler.forKeys.indexOf(event.keyCode) !== -1) {
          try {
            a = new SketchpadAction(handler);
    ...
    $(sketchpad).bind("mousedown", sketchpadMouseDown).bind("dblclick", sketchpadDblClick);
    $(window).bind("mousemove", sketchpadMouseMove).bind("mouseup", sketchpadMouseUp).bind("keydown", sketchpadKeyDown).bind("keyup", sketchpadKeyUp);
    /*
    ...
    */
    ...
    smallgraphsRunQuery = function() {
      var query, _ref;
      if (queryTypeEntryHandler != null) {
        queryTypeEntryHandler();
        queryTypeEntryHandler = null;
      }
      _ref = smallgraphsCompileSketchToQuery(), smallgraphsCurrentQuery = _ref[0], smallgraphsCurrentResultMapping = _ref[1];
      query = smallgraphsCurrentQuery;
      if (query.length === 0) {
        smallgraphsShowError("Empty query: Please sketch something to begin your search.");
        return;
      }
      return smallgraphsSendQuery(query, 0);
    };
    smallgraphsSendQuery = function(query, offset, msg) {
      var ajaxHandle, progress, queryURL, sgq;
      queryURL = "" + smallgraphsGraphURL + "/query";
      sgq = "<pre>" + (smallgraph.serialize(query)) + "</pre>";
      if (msg == null) {
        msg = offset === 0 ? "Running at " + queryURL + ":<br>" + sgq : "Getting " + ResultPageSize + " more results from " + queryURL + ":<br>" + sgq;
      }
      ajaxHandle = null;
      ...
      console.log("sending query to " + queryURL, "limiting range to " + offset + "-" + (offset + ResultPageSize), "\n" + (smallgraph.serialize(query)), query, "\n" + (JSON.stringify(query)));
      return ajaxHandle = $.ajax({
        type: 'POST',
        url: queryURL,
        ...
        error: function(jqXHR, textStatus, err) {
          ...
          return smallgraphsShowError(("Error occurred while running query at '" + queryURL + "':<br>") + ("<pre>" + textStatus + "\t" + err + "</pre>") + ("Your query was:" + sgq));
        }
      });
    };
    smallgraphsCompileSketchToQuery = function() {
      var addResultMapping, aggregationMap, aggregations, attributes, attrsToAggregate, e, edges, edgesUsed, first, i, id, last, nId, namedObjects, nodeOccurs, occ, orderings, outAttributeRelated, query, resultMapping, resultMappings, seenNode, stepLink, stepObject, w, walk, walks, ws, _i, _j, _k, _len, _len1, _len2;
      outAttributeRelated = function() {
      ...
      if ((w != null ? w.length : void 0) > 0) {
        ws.push(w);
      }
      nodeOccurs = {};
      seenNode = function(n) {
        if (nodeOccurs[n] == null) {
          nodeOccurs[n] = 0;
        }
        return nodeOccurs[n]++;
      };
      ws.forEach(function(w) {
        ...
        return w.forEach(function(e) {
          return seenNode(e.target.id);
        });
      });
      $(".node", sketch).filter(outAttributeRelated).filter(function() {
        ...
        return nodeOccurs[this.id] = 1;
      });
      resultMappings = [];
      addResultMapping = function(i, j, obj) {
        var labelAttrFromSchema, _ref, _ref1, _ref2, _ref3;
        labelAttrFromSchema = obj.objectType != null ? (_ref = smallgraphsGraphSchema.Objects) != null ? (_ref1 = _ref[obj.objectType]) != null ? _ref1.Label : void 0 : void 0 : obj.linkType != null ? (_ref2 = smallgraphsGraphSchema.Links) != null ? (_ref3 = _ref2[obj.linkType]) != null ? _ref3.Label : void 0 : void 0 : null;
        return (function(labelAttrFromSchema) {
          var getLabel;
          getLabel = labelAttrFromSchema != null ? function(step) {
            var _ref4, _ref5, _ref6;
            return (_ref4 = (_ref5 = (_ref6 = step.attrs) != null ? _ref6[labelAttrFromSchema] : void 0) != null ? _ref5 : step.label) != null ? _ref4 : step.id;
          } : function(step) {
            var _ref4;
            return (_ref4 = step.label) != null ? _ref4 : step.id;
          };
          return resultMappings.push(function(data, resultSVG) {
            var resultObj, step;
            step = data.walks[i][j];
            if (step == null) {
              return;
            ...
            resultObj.data = step;
            return resultObj.value = getLabel(step);
          });
        })(labelAttrFromSchema);
      };
      i = 0;
      ws.forEach(function(w) {
        ...
        if (w[0].target != null) {
          w.forEach(function(e) {
            ...
            return addResultMapping(i, j++, e.target);
          });
        }
        return i++;
      });
      stepObject = function(o, noref) {
      ...
      $(".attribute.edge", sketch).each(function(i, e) {
        var _ref;
        if (aggregationMap[e.source.id] != null) {
          aggregationMap[e.source.id].push([e.linkType, ((_ref = e.target.aggregateFunction) != null ? _ref : "count").toLowerCase(), e.target.constraint]);
        } else {
          attributes.push({
            look: [
              e.source.id, [
                {
                  name: e.linkType,
                  constraint: e.target.constraint
                }
              ]
            ]
          });
        ...
        resultMappings.push(function(data, resultSVG) {
          ...
          if (attr != null) {
            ...
            resultObj.data = v;
            return resultObj.value = v;
          }
        });
        return nodeOccurs[e.source.id]++;
      });
      $(".node", sketch).each(function(i, n) {
        if (n.labelConstraint != null) {
          nodeOccurs[n.id]++;
      ...
      aggregations = [];
      for (nId in aggregationMap) {
        attrsToAggregate = aggregationMap[nId];
        aggregations.push({
      ...
      sketchpadCurrentOrdering.forEach(function(n) {
        if ($(n).hasClass("attribute")) {
          return orderings.push([n.subjectId, n.attributeName, n.ordering]);
        } else {
          return orderings.push([n.id, null, n.ordering]);
        }
      });
      namedObjects = [];
      for (id in nodeOccurs) {
        occ = nodeOccurs[id];
        if (occ > 1) {
          namedObjects.push({
      ...
      walks = [];
      for (_j = 0, _len1 = ws.length; _j < _len1; _j++) {
        w = ws[_j];
        walk = [];
        walk.push(stepObject(w[0].source));
        if (w[0].target != null) {
          for (_k = 0, _len2 = w.length; _k < _len2; _k++) {
            e = w[_k];
      ...
      query = namedObjects.concat(walks).concat(attributes).concat(aggregations).concat({
        orderby: orderings
      });
      resultMapping = function(data, resultSVG) {
        return resultMappings.forEach(function(mapping) {
          return mapping(data, resultSVG);
        });
      };
      return [query, resultMapping];
    };
    results = $("#results");
    $("#result-more").text("Get " + ResultPageSize + " more...").button().click(function() {
      return smallgraphsSendQuery(smallgraphsCurrentQuery, smallgraphsCurrentOffset + ResultPageSize);
    });
    smallgraphsCurrentResultPrototype = null;
    smallgraphsCurrentResultOverview = null;
    smallgraphsShowResults = function(data, offset) {
      var aResult, addDataOverviewFor, column, d3sel, dataColorIndex, dataOverview, datum, elements, fillColor, firstNode, getValue, h, id, marker, maxX, maxY, minX, minY, overview, rect, resultHeight, resultPrototype, resultWidth, sketchHeight, sketchWidth, translateX, translateY, w, wScale, x, y, _i, _len;
      if (offset === 0) {
        $(".result", results).remove();
        if (smallgraphsCurrentResultPrototype != null) {
        ...
        resultPrototype = $("<div>").attr({
          "class": "result"
        }).css({
          width: "" + resultWidth + "px",
          height: "" + resultHeight + "px"
        }).append($(document.createElementNS(SVGNameSpace, "svg")).append($(sketch).parent().find("defs").clone()).append($(sketch).clone().removeAttr("id").attr({
        ...
        $(".edge text, text.constraint", resultPrototype).remove();
        $(".node text", resultPrototype).text("");
        smallgraphsCurrentResultPrototype = resultPrototype;
        dataOverview = {};
        dataColorIndex = 0;
        addDataOverviewFor = function(id, name, map) {
          dataOverview[id] = {
            id: id,
            attr: name,
            map: map,
          ...
          return dataColorIndex %= ResultFillColors.length;
        };
        smallgraphsCurrentQuery.forEach(function(decl) {
          var agg, id, look;
          if (decl.aggregate != null) {
            agg = decl.aggregate;
            id = agg[0];
            addDataOverviewFor(id, "label", function(d) {
              return d.names[id].label;
            });
            return agg[1].forEach(function(attrAgg) {
              var aggfn, attrName;
              attrName = attrAgg[0];
              aggfn = attrAgg[1];
              return $(".attribute.node", sketch).filter(function() {
                return this.subjectId === id && this.attributeName === attrName;
              }).toArray().forEach(function(attrNode) {
                return addDataOverviewFor(attrNode.id, attrName, function(d) {
                  return d.names[id].attrs[attrName];
                });
              });
            });
          } else if (decl.look != null) {
            look = decl.look;
            id = look[0];
            return look[1].forEach(function(attrName) {
              return $(".attribute.node", sketch).filter(function() {
                return this.subjectId === id && this.attributeName === attrName;
              }).toArray().forEach(function(attrNode) {
      ...
      for (id in smallgraphsCurrentResultOverview) {
        overview = smallgraphsCurrentResultOverview[id];
      ...
      for (id in smallgraphsCurrentResultOverview) {
        ...
        if (elements.hasClass("node")) {
          ...
          h = rect.attr("height");
          w = rect.attr("width");
          wScale = d3.scale.linear().domain([Math.min(0, overview.min), overview.max]).range([0, w]);
          getValue = function(n) {
            return [n.value];
          };
          column = elements.toArray().map(getValue);
          d3sel = d3.select(results[0]).selectAll("#" + id).data(column).selectAll(".overlay").data(Identity);
          d3sel.enter().append("svg:rect").attr("class", "overlay").style("fill", fillColor).attr("x", x).attr("y", y).attr("rx", NodeRounding).attr("ry", NodeRounding).attr("height", h).attr("width", 0).transition().duration(ResultUpdateTransitionDuration).attr("width", wScale);
          d3sel.transition().duration(ResultUpdateTransitionDuration).attr("width", wScale);
        }
      }
      ...
      if (offset === 0) {
        return $("#result-header").click();
      }
    };
    $("#query-run").button().click(smallgraphsRunQuery);
    generalizeConstraint = function(prevConstraint, disjs) {
      return [disjs];
    };
    smallgraphsToggleResultSelection = function(event) {
      return $(this).toggleClass("selected");
    };
    $("#result-refine").button().click(function() {
      var selectedResults;
      selectedResults = $(".result.selected", results);
      if (selectedResults.length > 0) {
        $(".node", sketchpad).filter(function() {
          return !$(this).hasClass("aggregate");
        }).each(function(i, node) {
          var attrDataType, constraintType, disjs, result, resultNode, v, _, _i, _len, _ref;
          _ref = determineNodeConstraintType(node), constraintType = _ref[0], _ = _ref[1], _ = _ref[2], attrDataType = _ref[3];
          if (node[constraintType] == null) {
            node[constraintType] = [];
          }
          disjs = [];
          for (_i = 0, _len = selectedResults.length; _i < _len; _i++) {
            result = selectedResults[_i];
            resultNode = $("#" + node.id, result)[0];
            if (constraintType === "labelConstraint" && !(resultNode.data.label != null)) {
              continue;
            }
            v = resultNode.value;
            disjs.push({
      ...
      return $("#query-header").click();
    });
    $("#result-reorder").button().click(function() {
      $("#result-refine").click();
      return setTimeout(function() {
        return $("#query-order").click();
      }, 500);
    });
    /*
      ## overall UI layout
    */
    ...
    $("#frame").accordion({
      ...
      changestart: function(event, ui) {
        ...
        return $("#" + ui.newContent.attr("id") + "-tools").addClass("active");
      }
    });
