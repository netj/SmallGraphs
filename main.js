...
(function() {
  ...
  exports.normalize = function(q) {
    ...
    eliminateEmptyConstraints = function(q) {
      var decl, elim, _i, _j, _len, _len2;
      elim = function(s) {
      ...
      for (_i = 0, _len = q.length; _i < _len; _i++) {
        decl = q[_i];
        if (decl["let"] != null) elim(decl["let"][1]);
      }
      for (_j = 0, _len2 = q.length; _j < _len2; _j++) {
        decl = q[_j];
        if (decl.walk != null) decl.walk.forEach(elim);
      }
      return q;
    };
  ...
  require(["order!jquery", "smallgraph/main", "d3.AMD", "order!jquery-ui", "order!jquery.svg", "order!jquery.svgdom", "order!jquery.cookie", "order!less"], function($, smallgraph, d3) {
    ...
    */
    ...
    try {
      ...
      if (smallgraphsGraphURLHistory == null) smallgraphsGraphURLHistory = [];
    } catch (err) {
          ...
          _results.push((function() {
            ...
            for (lnType in links) {
              ...
              _results2.push((function() {
                var _base, _i, _len, _ref2, _ref3, _ref4, _results3;
                _results3 = [];
                for (_i = 0, _len = targetObjTypes.length; _i < _len; _i++) {
                  targetObjType = targetObjTypes[_i];
                  _results3.push(((_ref2 = (_base = ((_ref3 = schema.Objects[targetObjType]) != null ? (_ref4 = _ref3.RevLinks) != null ? _ref4 : _ref3.RevLinks = {} : void 0))[lnType]) != null ? _ref2 : _base[lnType] = []).push(objType));
                }
                return _results3;
              })());
            }
    ...
    */
    ...
    queryTypeEntryShow = function(x, y, list, done) {
      ...
      if (queryTypeEntryHandler != null) queryTypeEntryHandler();
    ...
    */
    ...
    sketchpadAction_DrawEdgeFromANode = {
      ...
      mousedown: function() {
        var attrs, e, n, _ref, _ref2;
        n = getNode(event.target);
        if (n != null) {
          if (n.isAttributeNode) return null;
          ...
          $(e).addClass("drawing");
          this.objectSchema = (_ref = ((_ref2 = smallgraphsGraphSchema.Objects) != null ? _ref2 : {})[n.objectType]) != null ? _ref : emptyObjectSchema;
    ...
    sketchpadAction_RemoveSelection = {
      ...
      keypress: function() {
        ...
        $(".edge", sketchpad).filter(function() {
          return sketchpadCurrentSelection.indexOf(this.source) >= 0 || sketchpadCurrentSelection.indexOf(this.target) >= 0;
    ...
    sketchpadToggleAggregation = function() {
      if (aggregationSetupInProgress) return;
      sketchpadCurrentSelection.forEach(function(n) {
    ...
    sketchpadSetupOrdering = function(orderbyNodes) {
      ...
      if (orderbyNodes.length === 0) return;
    ...
    sketchpadAction_SwitchMode = {
      ...
      keypress: function() {
        ...
        return modes.each(function(i, b) {
          if (b === currentMode) return $(modes[(i + 1) % modes.length]).click();
        });
      }
    };
    /*
    ...
    */
        ...
        if (handler.mousedown != null) {
          ...
          try {
            ...
            if (r != null) {
              ...
              if (r) return sketchpadCurrentMouseActions.push(a);
            }
          } catch (err) {
    ...
    sketchpadMouseUp = function() {
      if (sketchpadFirstMouseEvent == null) return;
    ...
    sketchpadKeyDown = function() {
        ...
        if (handler.forKeys && handler.forKeys.indexOf(event.keyCode) !== -1) {
          if (handler.keydown != null) {
            try {
              ...
              if (r != null) {
                console.debug(event.type, event, a, a.name);
                if (r) return sketchpadCurrentKeyActions.push(a);
              }
            } catch (err) {
              return console.error(err, err + "");
            }
      ...
      if (!event.metaKey) return event.preventDefault();
    };
    ...
    */
    ...
    smallgraphsSendQuery = function(query, offset, msg) {
      ...
      if (typeof debugResultURL === "string") queryURL = debugResultURL;
    ...
    smallgraphsCompileSketchToQuery = function() {
      var addResultMapping, aggregationMap, aggregations, attributes, attrsToAggregate, e, edges, edgesUsed, first, i, id, last, nId, namedObjects, nodeOccurs, occ, orderings, outAttributeRelated, query, resultMapping, resultMappings, seenNode, stepLink, stepObject, w, walk, walks, ws, _i, _j, _k, _len, _len2, _len3;
      ...
      if ((w != null ? w.length : void 0) > 0) ws.push(w);
      nodeOccurs = {};
      seenNode = function(n) {
        if (nodeOccurs[n]) {
          return nodeOccurs[n]++;
        } else {
          return nodeOccurs[n] = 1;
        }
      };
      ...
      addResultMapping = function(i, j, obj) {
        var labelAttrFromSchema, _ref, _ref2, _ref3, _ref4;
        labelAttrFromSchema = obj.objectType != null ? (_ref = smallgraphsGraphSchema.Objects) != null ? (_ref2 = _ref[obj.objectType]) != null ? _ref2.Label : void 0 : void 0 : obj.linkType != null ? (_ref3 = smallgraphsGraphSchema.Links) != null ? (_ref4 = _ref3[obj.linkType]) != null ? _ref4.Label : void 0 : void 0 : null;
        return (function(labelAttrFromSchema) {
          var getLabel;
          getLabel = labelAttrFromSchema != null ? function(step) {
            var _ref5, _ref6, _ref7;
            return (_ref5 = (_ref6 = (_ref7 = step.attrs) != null ? _ref7[labelAttrFromSchema] : void 0) != null ? _ref6 : step.label) != null ? _ref5 : step.id;
          } : function(step) {
            var _ref5;
            return (_ref5 = step.label) != null ? _ref5 : step.id;
          };
          return resultMappings.push(function(data, resultSVG) {
            var resultObj, step;
            step = data.walks[i][j];
            if (step == null) return;
            if (typeof step === "string") step = data.names[step];
      ...
      sketchpadCurrentOrdering.forEach(function(n) {
        if (!$(n).hasClass("attribute")) return nodeOccurs[n.id]++;
      });
      attributes = [];
      $(".attribute.edge", sketch).each(function(i, e) {
        var _ref;
        if (aggregationMap[e.source.id] != null) {
          aggregationMap[e.source.id].push([e.linkType, ((_ref = e.target.aggregateFunction) != null ? _ref : "count").toLowerCase()]);
        } else {
          attributes.push({
      ...
      walks = [];
      for (_j = 0, _len2 = ws.length; _j < _len2; _j++) {
        w = ws[_j];
        walk = [];
        walk.push(stepObject(w[0].source));
        if (w[0].target != null) {
          for (_k = 0, _len3 = w.length; _k < _len3; _k++) {
            e = w[_k];
    ...
    smallgraphsShowResults = function(data, offset) {
      ...
      for (id in smallgraphsCurrentResultOverview) {
        ...
        if (elements.hasClass("node")) {
          ...
          h = rect.attr("height");
          w = rect.attr("width");
          wScale = d3.scale.linear().domain([overview.min, overview.max]).range([0, w]);
          getValue = function(n) {
            return [n.value];
          };
      ...
      if (offset === 0) return $("#result-header").click();
    };
