...
public abstract class BaseSmallGraphGiraphVertex
    extends EdgeListVertex<LongWritable, DoubleWritable, FloatWritable, DoubleWritable>
    implements Tool
    {
  ...
  private static final Logger LOG =
      Logger.getLogger(BaseSmallGraphGiraphVertex.class);
  /** Configuration */
  private Configuration conf;

  protected abstract void handleMessage(int msgId, MatchPath path, Match match);
  ...
  public void compute(Iterator<DoubleWritable> msgIterator) {
    ...
    double minDist = 0d; //isSource() ? 0d : Double.MAX_VALUE;
